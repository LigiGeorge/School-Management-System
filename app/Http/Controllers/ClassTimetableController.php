...
class ClassTimetableController extends Controller
{
    public function list(Request $request)
    {
        ...
        foreach($getWeek as $value)
        {
            ...
            {
                $ClassSubject = ClassSubjectTimetableModel::getRecordClassSubject($request->class_id,
                $request->subject_id,$value->id);
    ...
    public function MyTimetableTeacher($class_id,$subject_id)
    {
        ...
        foreach($getWeek as $valueW)
        {
            $dataW = array();                
            $dataW['week_name'] = $valueW->name;
            $ClassSubject = ClassSubjectTimetableModel::getRecordClassSubject($class_id,
