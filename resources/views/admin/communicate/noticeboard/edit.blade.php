                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <label style="margin-right : 50px;">
                        <input {{ !empty($message_to_student) ? 'checked' : '' }} type="checkbox" name="message_to[]" value="3"> Student
                    </label>
                    <label style="margin-right : 50px;">
                        <input {{ !empty($message_to_parent) ? 'checked' : '' }} type="checkbox" name="message_to[]" value="4"> Parent
                    </label>
                    <label style="margin-right : 50px;">
                        <input {{ !empty($message_to_teacher) ? 'checked' : '' }} type="checkbox" name="message_to[]" value="2"> Teacher
                    </label>
                  </div>
                  <div class="form-group">
                    <label>Message</label>
