  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="overflow-y: auto;">
    ...
    <img src="{{ $getHeaderSetting->getLogo() }}" style="width:auto;height:50px;border-radius:4px;" alt="">
    @else    
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{url('student/fees_collection')}}" class="nav-link  @if( Request::segment(2)=='fees_colection') active @endif ">
              <i class="nav-icon far fa-user"></i>
              <p>
              Fees Collection
              </p>
