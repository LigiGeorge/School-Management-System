      ...
      <div class="container-fluid">
        ...
        <div class="card">  
              ...
              {{csrf_field()}}
                <div class="card-body">
                  ...
                  <div class="form-group col-md-3">
                    ...
                    <a href="{{url('parent/my_student/submitted_homework/'.$getStudent->id)}}" class="btn btn-success" style="margin-top: 50px;">Reset</a>
                  </div>
          ...
          @include('_message')
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Student Submited Homework List</h3>
              </div>
              <!-- /.card-header -->
