              ...
              {{csrf_field()}}
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="date" name="homework_date" value="{{ $getRecord->homework_date }}" class="form-control" required>
                  </div>
                  <div class="form-group">
                    <label>Submission Date <span style="color:red;">*</span></label>
                    <input type="date" name="submission_date" value="{{ $getRecord->submission_date }}" class="form-control" required>
                  </div>
                  <div class="form-group">
                    <label>Document</label>
                    <input type="file" name="document_file" class="form-control">
                    @if(!empty($getRecord->getDocument()))
                      <a href="{{ $getRecord->getDocument() }}" download="" class="btn btn-primary">Download</a>
                      @endif
                  </div>
                  <div class="form-group">
